package kr.or.ms.member.model.vo;
...
public class Member {
	...
	public Member(int mNo, String mId, String mPw, String mNickName, String mEmail, String mPhone, String mAddress,
			String mActive, Date mEnroll) {
		super();
		this.mNo = mNo;
		this.mId = mId;
		this.mPw = mPw;
